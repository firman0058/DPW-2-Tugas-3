                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{url('public')}}/images/pc.png" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{url('public')}}/images/pct.png" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <div class="three_box">
         <div class="container">
            <div class="row">
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/images/about.jpg" alt="#"/></i>
                     <h3>Computer</h3>
               ...
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/images/leptop.jpg" alt="#"/></i>
                     <h3>Laptop</h3>
                     <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box_text">
                     <i><img src="{{url('public')}}/images/rams.png" alt="#"/></i>
                     <h3>Rams</h3>
                     <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                  </div>
               </div>
      ...
      <div class="about">
         <div class="container">
            <div class="row d_flex">
               ...
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="{{url('public')}}/images/MKA-3C.jpg" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-md-7">
                  <div class="laptop1_img">
                     <figure><img src="{{url('public')}}/images/-mouse-png-pc.png" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="titlepage">
